...
public class AdminViewRoomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminViewRoomsActivity.this, AdminDashboardActivity.class);
    ...
    private void applyFilters(String selectedRoomType) {
        ...
        roomsAdapter.filterByRoomTypePriceAndAvailability(selectedRoomType, minPrice, maxPrice, onlyAvailable);
    }
}